...
async function plantSubmit(e) {
    ...
    await fetch("/plant", { // send request to /plant endpoint in server.js (express server)
...
async function updateEntriesInPage() {
    const response = await fetch("/plants"); // send request to /plants endpoint in server.js (express server)
